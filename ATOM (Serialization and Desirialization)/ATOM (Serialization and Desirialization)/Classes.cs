class Atom
{
    ...
    public static Atom Parse(string line)
    {
        ...
        {
            userAtom = new Atom(userLine[0], userLine[4], Convert.ToInt32(userLine[1]), Convert.ToInt32(userLine[2]), Convert.ToDouble(userLine[3]));
            return userAtom;
        }
        else throw new Exception("the line data you provided does not consist of five parts");
    }
    public static List<Atom> CreateAtoms()
    {
